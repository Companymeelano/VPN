...
class MainActivity : ComponentActivity() {
    ...
    private companion object {
        // "hy2" is the widely deployed alias for the very same hysteria2 scheme - lists that use
        // the short form previously fell through to the no-op else and opened the app silently.
        val IMPORT_SCHEMES = setOf("vless", "vmess", "trojan", "ss", "hysteria2", "hy2")
    }
}
