...
object Ladder {
    ...
    /**
     * Score contribution from transport preference: linear and small (2..16 for the 8-key ladder:
     * (n - i) * (14/n + 1)). It must not outrank measured quality - a reachable C node beats an
     * unreachable A, always.
     */
